...
#        #objectx.append((ln*4/numberpoint-2))
...
# lensposx=[0.2, -0.2, 0, -0.5]
# lensposy=[0.01, 0.01, 0.3, -0.5]
...
for objects in range(len(objectx)):
    for lens in range(len(lensposx)):
        if lens == 1:
            ...
            m = 1
        vecx = (lensposx[lens] - objectx[objects]) / \
               mvec((lensposx[lens] - objectx[objects]), (lensposy[lens] - objecty[objects])) * \
               theta(m, mvec((lensposx[lens] - objectx[objects]), (lensposy[lens] - objecty[objects])))
        vecy = (lensposy[lens] - objecty[objects]) / \
               mvec((lensposx[lens] - objectx[objects]), (lensposy[lens] - objecty[objects])) * \
               theta(m, mvec((lensposx[lens] - objectx[objects]), (lensposy[lens] - objecty[objects])))
