...
for objects in range(len(objectx)):
    for lens in range(len(lensposx)):
        ...
        vecx2=(lensposx[lens]-objectx[objects])/mvec((lensposx[lens]-objectx[objects]),(lensposy[lens]-objecty[objects]))*theta2(m, mvec((lensposx[lens]-objectx[objects]),(lensposy[lens]-objecty[objects])))
        vecy2=(lensposy[lens]-objecty[objects])/mvec((lensposx[lens]-objectx[objects]),(lensposy[lens]-objecty[objects]))*theta2(m, mvec((lensposx[lens]-objectx[objects]),(lensposy[lens]-objecty[objects])))
